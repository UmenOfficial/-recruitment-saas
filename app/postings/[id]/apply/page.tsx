...
function ApplicationFormContent() {
    ...
    // const supabase = ... removed, using imported singleton
    ...
    if (isLoading) {
        return <div className="text-center py-10">Loading form configuration...</div>;
    }
    ...
    return (
        <div className="container mx-auto py-10 px-4 max-w-4xl">
            <div className="mb-8 text-center">
                <h1 className="text-3xl font-bold mb-2">입사 지원서</h1>
                <p className="text-gray-500">모든 항목을 성실히 작성해주세요.</p>
            </div>
